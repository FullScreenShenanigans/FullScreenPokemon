...
export class Objects<TEightBittr extends FullScreenPokemon> extends EightBittrObjects<TEightBittr> {
    ...
    public readonly properties: IClassProperties = {
        ...
        Area: {
            background: "black",
            onMake: this.eightBitter.maps.areaProcess,
            attributes: {
        ...
        Character: {
            ...
            onThingAdd: this.eightBitter.actions.spawnCharacter,
        ...
        Pokeball: {
            action: "item",
            activate: this.eightBitter.actions.activatePokeball,
            borderPrimary: true,
        },
        Rival: {
            id: "Rival",
        ...
        Cabinet: [32, 64],
        CollisionDetector: {
            collide: this.eightBitter.collisions.detectors.collideCollisionDetector,
            active: false,
            hidden: true,
        },
        AreaGate: {
            activate: this.eightBitter.actions.activateAreaGate,
            active: true,
            requireOverlap: true,
        },
        CutsceneTriggerer: {
            activate: this.eightBitter.actions.activateCutsceneTriggerer,
            requireOverlap: true,
        },
        MenuTriggerer: {
            activate: this.eightBitter.actions.activateMenuTriggerer,
        },
        SightDetector: {
            activate: this.eightBitter.actions.activateSightDetector,
            requireOverlap: true,
            hidden: true,
        },
        ThemePlayer: {
            activate: this.eightBitter.actions.activateThemePlayer,
            requireOverlap: true,
            hidden: true,
        },
        Transporter: {
            activate: this.eightBitter.actions.activateTransporter,
            requireOverlap: true,
            hidden: false,
        },
        HiddenTransporter: {
        ...
        GymStatue: {
            height: 64,
            activate: this.eightBitter.actions.activateGymStatue,
        },
        HealingMachine: [64, 64],
        HealingMachineBall: [12, 12],
        HMCharacter: {
            activate: this.eightBitter.actions.activateHMCharacter,
        },
        CuttableTree: {
            moveName: "Cut",
            moveCallback: this.eightBitter.actions.partyActivateCut,
            requiredBadge: "Cascade",
        },
        StrengthBoulder: {
            moveName: "Strength",
            moveCallback: this.eightBitter.actions.partyActivateStrength,
            speed: 4,
        ...
        Ledge: {
            ...
            spritewidth: 16,
            direction: 2,
            collide: this.eightBitter.collisions.obstacles.collideLedge,
            attributes: {
                jagged: {
                    spritewidth: 64,
                },
        ...
        Spawner: {
            hidden: true,
            onThingAdd: this.eightBitter.actions.activateSpawner,
        },
        AreaSpawner: {
            activate: this.eightBitter.actions.spawnAreaSpawner,
        },
        SquareWallTop: {
            spriteheight: 2,
        },
        ...
        WaterEdge: {
            height: 16,
            width: 16,
            collide: this.eightBitter.collisions.obstacles.collideWaterEdge,
            activate: this.eightBitter.actions.activateHMCharacter,
            moveName: "Surf",
            moveCallback: this.eightBitter.actions.partyActivateSurf,
            requiredBadge: "Soul",
        },
        WaterEdgeTop: {
            exitDirection: 0,
        ...
        WindowDetector: {
            hidden: true,
            onThingAdd: this.eightBitter.actions.spawnWindowDetector,
        },
        FloorLinedHorizontal: {
            spritewidth: 2,
            spriteheight: 8,
