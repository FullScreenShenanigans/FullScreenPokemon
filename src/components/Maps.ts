...
import { MacroAnimations } from "./maps/MacroAnimations";
...
export class Maps<TEightBittr extends FullScreenPokemon> extends EightBittrMaps<TEightBittr> {
     ...
     * Map creation macros.
     */
    @component(MacroAnimations)
    public readonly macroAnimations: MacroAnimations<TEightBittr>;
    ...
    public readonly macros = {
        Checkered: this.macroAnimations.macroCheckered,
        Water: this.macroAnimations.macroWater,
        House: this.macroAnimations.macroHouse,
        HouseLarge: this.macroAnimations.macroHouseLarge,
        Building: this.macroAnimations.macroBuilding,
        Gym: this.macroAnimations.macroGym,
        Mountain: this.macroAnimations.macroMountain,
        PokeCenter: this.macroAnimations.macroPokeCenter,
        PokeMart: this.macroAnimations.macroPokeMart,
    };
