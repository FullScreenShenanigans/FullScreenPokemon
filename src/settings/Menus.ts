import {
    IListMenuSchema, IMenuChildSchema, IMenuGraphrSettings,
    IMenuThingSchema, IMenuWordPadLeftCommand,
} from "menugraphr";
 ...
 */
export const GenerateMenusSettings = (fsp: FullScreenPokemon): Partial<IMenuGraphrSettings> => ({
    aliases: {
        " ": "Space",
        "(": "LeftParenthesis",
        ")": "RightParenthesis",
    ...
    replacements: {
        "PLAYER": (): string[] =>
            fsp.itemsHolder.getItem("name"),
        "RIVAL": (): string[] =>
            fsp.itemsHolder.getItem("nameRival"),
        "POKE": "POK�".split(""),
        ...
        "MONEY": (): string[] =>
            fsp.itemsHolder.getItem("money").toString().split(""),
    },
    sounds: {
