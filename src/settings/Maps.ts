import { IMapsModuleSettings as IGameStartrIMapsModuleSettings } from "gamestartr";
 ...
 * and MapsCreatr.
 */
export interface IMapsModuleSettings extends IGameStartrIMapsModuleSettings {
    /**
 ...
 */
export const GenerateMapsSettings = (fsp: FullScreenPokemon): IMapsModuleSettings => ({
    mapDefault: "Blank",
