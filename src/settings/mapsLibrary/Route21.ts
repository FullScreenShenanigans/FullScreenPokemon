    ...
    areas: {
        Land: {
            ...
            creation: [
                ...
                { macro: "Checkered", things: ["", "Flower"], x: 320, y: 80, xnum: 8, ynum: 2, xwidth: 16, yheight: 16 },
                { thing: "Grass", x: 256, y: 128, width: 192, height: 192 },
                { macro: "Checkered", things: ["", "Flower"], x: 512, y: 144, xnum: 4, ynum: 2, xwidth: 16, yheight: 16 },
                { macro: "Checkered", things: ["", "Flower"], y: 144, xnum: 4, ynum: 2, xwidth: 16, yheight: 16 },
                { macro: "Checkered", things: ["", "Flower"], y: 208, xnum: 4, ynum: 2, xwidth: 16, yheight: 16 },
                { macro: "Checkered", things: ["", "Flower"], y: 272, xnum: 4, ynum: 2, xwidth: 16, yheight: 16 },
                { macro: "Water", x: 128, y: 320, width: 128, height: 128, open: [true, true, true, false] },
                { macro: "Checkered", things: ["", "Flower"], y: 336, xnum: 4, ynum: 2, xwidth: 16, yheight: 16 },
