    ...
    areas: {
        Land: {
            ...
            creation: [
                ...
                { thing: "Ledge", x: 128, y: 160, width: 160, crumbleRight: true },
                { thing: "Ledge", x: 320, y: 160, width: 128, jagged: true },
                ...
                { thing: "Ledge", x: 128, y: 288, width: 160, crumbleRight: true },
                ...
                { thing: "Ledge", x: 192, y: 416, width: 128 },
                ...
                { thing: "Ledge", x: 128, y: 608, width: 32 },
                { thing: "LedgeOpening", x: 160, y: 608, width: 32 },
                { thing: "Ledge", x: 192, y: 608, width: 96, crumbleLeft: true, crumbleRight: true },
                { thing: "LedgeOpening", x: 288, y: 608, width: 32 },
                { thing: "Ledge", x: 320, y: 608, width: 256 },
                ...
                { thing: "Ledge", x: 128, y: 864, width: 64, jagged: true },
                { thing: "Ledge", x: 320, y: 864, width: 256, jagged: true },
