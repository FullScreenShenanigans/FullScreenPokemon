            ...
            "areas": {
                "Ground Floor": {
                    ...
                    "creation": [
                        ...
                        { "thing": "Pokeball", "x": 48, "y": 24, "id": "PokeballCharmander", "actions": ["Pokedex", "Dialog", "Yes/No"], "pokemon": "Charmander", "dialog": "So! You want the fire %%%%%%%POKEMON%%%%%%%, CHARMANDER?", "routine": "PlayerTakesPokemon" },
                        { "thing": "Pokeball", "x": 56, "y": 24, "id": "PokeballSquirtle", "actions": ["Pokedex", "Dialog", "Yes/No"], "pokemon": "Squirtle", "dialog": "So! You want the water %%%%%%%POKEMON%%%%%%%, SQUIRTLE?", "routine": "PlayerTakesPokemon" },
                        { "thing": "Pokeball", "x": 64, "y": 24, "id": "PokeballBulbasaur", "actions": ["Pokedex", "Dialog", "Yes/No"], "pokemon": "Bulbasaur", "dialog": "So! You want the plant %%%%%%%POKEMON%%%%%%%, BULBASAUR?", "routine": "PlayerTakesPokemon" },
                        ...
                        { "thing": "CutsceneTriggerer", "x": 32, "y": 56, "width": 32, "id": "RivalBlocker", "routine": "RivalBattleChallenge", "nocollide": true },
