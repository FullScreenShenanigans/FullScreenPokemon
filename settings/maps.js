            ...
            "areas": {
                "Ground Floor": {
                    ...
                    "creation": [
                        ...
                        { "thing": "RivalMother", "x": 16, "y": 24, "dialog": "Hi %%%%%%%PLAYER%%%%%%%! %%%%%%%RIVAL%%%%%%% is out at Grandpa's lab." },
            ...
            "areas": {
                "Ground Floor": {
                    ...
                    "creation": [
                        ...
                        { "thing": "Lady", "x": 8, "y": 72, "dialog": ["PROF.OAK is the authority on %%%%%%%POKEMON%%%%%%%!", "Many %%%%%%%POKEMON%%%%%%% trainers hold him in high regard!"] },
                        { "thing": "Scientist", "x": 16, "y": 80, "dialog": "I study %%%%%%%POKEMON%%%%%%% as PROF.OAK's aide." },
                        { "thing": "Scientist", "x": 64, "y": 80, "dialog": "I study %%%%%%%POKEMON%%%%%%% as PROF.OAK's aide." },
