    ...
    var FullScreenPokemon = (function (_super) {
        ...
        */
        ...
        FullScreenPokemon.prototype.openPokemonMenuStats = function (pokemon) {
            var FSP = FullScreenPokemon.prototype.ensureCorrectCaller(this), schemas = FSP.MathDecider.getConstant("pokemon"), schema = schemas[pokemon.title.join("")], barWidth = 25, health = FSP.MathDecider.compute("widthHealthBar", barWidth, pokemon.HP, pokemon.HPNormal);
        ...
        */
        ...
        /**
         * Ctscene for placing Pokeballs into the healing machine.
         *
         * @param FSP
         * @param settings   Settings used for the cutscene.
         */
        ...
        /**
         * Ctscene showing the PokeMart action options.
         *
         * @param FSP
         * @param settings   Settings used for the cutscene.
         */
         ...
         */
        FullScreenPokemon.prototype.cutsenePokeMartBuyMenu = function (FSP, settings) {
        ...
        /**
         * Cutscene showng the exclamation point over the player's head.
         *
         * @param FSP
         * @param settings   Settings used for the cutscene.
         */
        ...
        FullScreenPokemon.prototype.cutsceneOakParcelPickupCounterDialog = function (FSP, settings) {
            FSP.MenuGrapher.createMenu("GeneralText");
            FSP.MenuGrapher.addMenuDialog("Generalext", [
         ...
         * @param settings   Settings used for the cutscene.
         */
        FullScreenPokemon.prototype.cutsceneOakParceDeliveryRivalInterrupts = function (FSP, settings) {
            FSP.MenuGrapher.createMenu("GeneralText");
            FSP.MenuGrapher.addMenuDialog("GeneralText", [
                "%%%%%%%RIVAL%%%%%%%: Gramps!"
        ...
        /**
         * Cutscene for the rivl asking Oak why he was called.
         *
         * @param FSP
         * @param settings   Settings used for the cutscene.
         */
